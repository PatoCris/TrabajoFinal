 ...
 * @author Asus
 */
public class GestionTipoReparacion extends javax.swing.JInternalFrame {
    private ControladoraVista cv;
    private UtilVista util;
    private String bandera;
    private DefaultTableModel miTabla;
    /**
     * Creates new form GestionTipoReparacion
     */
    public GestionTipoReparacion(ControladoraVista controladoraVista) throws Exception {
        initComponents();
        cv = controladoraVista;
        util = new UtilVista();
        cargarTabla(tblTiposRecambio, cv.traerTipoReparacion(true));
        estadoInicio();
    }
public void limpiar(){
        txtCodigo.setText("");
    ...
    public void estadoInicio(){
        ...
        public void cargarTabla(JTable laTabla, List<TipoReparacion> lista) throws Exception {
        ...
        if (cantidad > 0) {
            for (TipoReparacion tipoReparacion : lista) {
                fila[0] = tipoReparacion.getCodigo();
                fila[1] = tipoReparacion.getNombre();
                fila[2] = tipoReparacion.getDescripcion();
                miTabla.addRow(fila);
            }
        }
    ...
    private void initComponents() {
        ...
        tblTiposRecambio = new javax.swing.JTable();
        ...
        tblTiposRecambio.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null},
                {null, null},
                {null, null},
        ...
        tblTiposRecambio.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tblTiposRecambioMouseClicked(evt);
            }
        });
        jScrollPane2.setViewportView(tblTiposRecambio);
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        if(tblTiposRecambio.getSelectedRow() != -1){
            bandera = "editar";
            ...
            JOptionPane.showMessageDialog(null, "Seleccione un Tipo de Reparación para editar.");
        }
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        try {
            ...
            if(bandera.equals("nuevo")){
                this.cv.nuevoTipoReparacion(nombre, descripcion);
                bandera = "";
                estadoInicio();
            }else{
                if(bandera.equals("editar")){
                    int codigo = Integer.valueOf(txtCodigo.getText());
                    this.cv.editarTipoReparacion(codigo, nombre, descripcion);
                    estadoInicio();
                }
            }
            cargarTabla(tblTiposRecambio, cv.traerTipoReparacion(true)); //ACTUALIZAMOS LA TABLA
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(null, ex.getMessage());
        }
    ...
    private void btnBusquedaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBusquedaActionPerformed
        if(!txtBusqueda.getText().isEmpty()){
            ...
            try {
                cargarTabla(tblTiposRecambio, cv.traerTipoReparacionNombre(true, busqueda));
            } catch (Exception ex) {
                JOptionPane.showMessageDialog(null, ex.getMessage());
            }
        }else{
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        try {
            if(tblTiposRecambio.getSelectedRow() != -1){
                int seleccion = JOptionPane.showConfirmDialog(null, "¿Está seguro desea eliminar el tipo de reparacion?", "Input", JOptionPane.YES_NO_OPTION);
                if (seleccion == JOptionPane.YES_OPTION) {
                    int codigo = Integer.valueOf(tblTiposRecambio.getValueAt(tblTiposRecambio.getSelectedRow(), 0).toString());
                    cv.elminarTipoRepracion(codigo);
                    cargarTabla(tblTiposRecambio, cv.traerTipoReparacion(true));
                }
            }else{
                JOptionPane.showMessageDialog(null, "Seleccione un Tipo de Reparacion de la lista.");
            }
        } catch (Exception e) {
    ...
    private void tblTiposRecambioMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblTiposRecambioMouseClicked
        if(tblTiposRecambio.getSelectedRow() != -1){
            txtCodigo.setText(tblTiposRecambio.getValueAt(tblTiposRecambio.getSelectedRow(), 0).toString());
            txtNombre.setText(tblTiposRecambio.getValueAt(tblTiposRecambio.getSelectedRow(), 1).toString());
            tarDescripcion.setText(tblTiposRecambio.getValueAt(tblTiposRecambio.getSelectedRow(), 2).toString());
        }
    }//GEN-LAST:event_tblTiposRecambioMouseClicked
    ...
    private javax.swing.JTable tblTiposRecambio;
